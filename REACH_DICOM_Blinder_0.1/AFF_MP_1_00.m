...
%      singleton*.
%
%      H = AFF_MP_1_00 returns the handle to a new AFF_MP_1_00 or the handle to
%      the existing singleton*.
%
%      AFF_MP_1_00('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in AFF_MP_1_00.M with the given input arguments.
%
%      AFF_MP_1_00('Property','Value',...) creates a new AFF_MP_1_00 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before AFF_MP_1_00_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to AFF_MP_1_00_OpeningFcn via varargin.
%
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @AFF_MP_1_00_OpeningFcn, ...
                   'gui_OutputFcn',  @AFF_MP_1_00_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before AFF_MP_1_00 is made visible.
function AFF_MP_1_00_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to AFF_MP_1_00 (see VARARGIN)

handles.version = '1_00';
handles.activefile = '';
handles.errorlog = {};

% Choose default command line output for AFF_MP_1_00
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes AFF_MP_1_00 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = AFF_MP_1_00_OutputFcn(hObject, eventdata, handles) 
